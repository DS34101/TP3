...
TEST(test_calculadora, todaslasOperaciones){
    ...
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),3);
    EXPECT_EQ(c.Pila().top(),5);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),4);
    EXPECT_EQ(c.valorActualVariable("var"),5);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),5);
    EXPECT_EQ(c.Pila().top(),5);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),6);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),7);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),8);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),9);
    EXPECT_EQ(c.Pila().top(),10);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),10);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),11);
    EXPECT_EQ(c.Pila().top(),50);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),12);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),13);
    EXPECT_EQ(c.Pila().top(),45);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),14);
    EXPECT_EQ(c.Pila().top(),-45);
    c.ejecutarUnPaso();
    EXPECT_EQ(c.IndiceInstruccionActual(),15);
    c.ejecutarUnPaso();
